    ...
    xhttp.onreadystatechange  = function () {
                                    ...
                                    if (this.readyState == 4 && this.status == 200) {
                                        ...
                                        if(resultJSON.message != 'Erro a devolver doentes'){
                                            ...
                                            for(var i=0; i<jsonResult.length; i++){
                                                ...
                                                fillstring += '<img class="img-fluid d-block mx-auto bolitas" alt=""  style="background-image: url('+imagePath+imageName+')">';
                                   ...
                                   /* console.log('Aqui supostamente e o plus');
                                    /* Sinal plus */ 
                                        ...
                                        fillstring+= '<img class="img-fluid d-block mx-auto bolitas_plus" style="" alt="">';
                                        fillstring+= '</a>';
                                        fillstring+= '</div>';
